...
const PROJECT_DETAILS = {
    ...
    'ai-wars': {
        title: 'A.I Wars',
        summary: '타 본부의 기획·개발 인력 부족 상황에서 지원 요청을 받아, 동료 프로그래머·이펙터와 셋이서 약 4개월간 미니 게임의 아이디어 구체화부터 기획·개발까지 A부터 Z를 함께 만들어낸 프로젝트입니다. 정식 서비스 시 밸런스 조정의 효율성을 높이기 위해 모든 시스템과 콘텐츠를 DB 테이블 및 Inspector 기반으로 관리할 수 있는 구조로 기획했습니다.',
        team: '본부 간 협업',
