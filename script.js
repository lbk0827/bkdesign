...
const PROJECT_DETAILS = {
    ...
    'color-slide-jam': {
        ...
        summary: '슬라이딩 블록 퍼즐을 기반으로 한 글로벌 서비스 캐주얼 게임으로, 인게임·시스템·콘텐츠·BM까지 폭넓은 기획을 담당했던 프로젝트입니다. 기믹 32종을 기획·적용하여 플레이의 다양성과 BM 접점을 동시에 확대했으며, 스테이지 약 300종을 직접 제작·검증하여 리텐션 성장을 견인했습니다. 기획팀·개발팀·QA 간 협업 효율을 위해 기믹 상호작용 통합 가이드를 구축하여 단일 기준점 체계를 마련했습니다.',
        team: '기획/개발/QA/아트 협업',
