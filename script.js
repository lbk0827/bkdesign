...
const PROJECT_DETAILS = {
    'bash-fiesta': {
        ...
        responsibilities: [
            { tag: '인게임 핵심 시스템 기획/개발', desc: '코어(캔 넘어뜨리기 3D 물리 퍼즐)와 대포·로켓·미사일 등 기믹, 부스터 시스템을 기획하고 바이브 코딩으로 직접 구현' },
        ...
        coreFeatures: [
            { title: '물리 퍼즐 코어', description: '대포로 공을 발사해 캔을 넘어뜨리는 3D 물리 퍼즐. 대포·로켓·미사일 등 기믹으로 스테이지에 변주를 부여' },
    ...
    'match-hexa-deck': {
        ...
        achievements: [
            '헥사 보드 퍼즐 코어 로직을 구현하여 매칭, 조작, 클리어/실패 조건을 실제 플레이 가능한 형태로 완성',
            '레벨 제작 도구 및 구성 규칙을 설계하여 반복 제작 가능한 스테이지 제작 기반 마련'
        ],
        coreFeatures: [
    ...
    'stud-pop': {
        ...
        achievements: [
            '레벨 에디터 구축 및 스테이지 100종 제작을 통해 3D 퍼즐 스테이지 제작 환경 마련',
            '3D 퍼즐 코어 로직을 직접 구현하며 블록 매칭, 카메라 조작, 기믹 처리까지 개발 범위 확장'
        ],
        coreFeatures: [
            { title: '작성 예정', description: '작성 예정' }
        ],
