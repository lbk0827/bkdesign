...
const PROJECT_DETAILS = {
    ...
    'spinning-in-space': {
        ...
        summary: '미국 Double Down Interactive(DDI)와 공동 개발한 어드벤처 기반 소셜 카지노 게임으로, 기획자로서 첫 걸음을 뗀 프로젝트다. 데이터 테이블 설계부터 튜토리얼, 라이브 서비스 시스템 기획까지 폭넓은 실무를 경험하며, 해외 팀과의 영문 커뮤니케이션 역량도 함께 쌓았다.',
        team: '기획/개발 협업',
