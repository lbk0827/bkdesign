...
const PROJECT_DETAILS = {
    ...
    '3on3-freestyle': {
        ...
        summary: 'PS4·PS5·Steam에서 글로벌 서비스 중인 3v3 스트리트 농구 게임으로, PM으로서 첫 커리어를 시작한 프로젝트다. 상품/BM 기획부터 콘텐츠·이벤트 설계, 지표 분석까지 라이브 서비스 운영의 전 과정을 경험했으며, SONY 글로벌 팀과의 직접 협업과 매출 구조 개편 등을 주도하며 데이터 기반 의사결정의 기초를 다졌다.',
        team: '사업/기획/운영 협업',
