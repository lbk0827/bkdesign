...
const PROJECT_DETAILS = {
    ...
    'spinning-in-space': {
        ...
        summary: '미국 지사 Double Down Interactive(DDI)와 공동 개발한 어드벤처 기반 소셜 카지노 게임으로, 기획자로서 첫 걸음을 뗀 프로젝트다. 데이터 테이블 설계부터 튜토리얼, 라이브 서비스 시스템 기획까지 폭넓은 실무를 경험했으며, 해외 팀과 직접 소통하며 글로벌 환경에서 협업하는 값진 경험을 쌓았다.',
        team: '기획/개발 협업',
    ...
    '3on3-freestyle': {
        ...
        summary: 'PS·Xbox·Steam에서 글로벌 서비스 중인 3v3 스트리트 농구 게임으로, PM 직무로 게임 업계에 입문한 프로젝트다. 상품/BM 기획부터 콘텐츠·이벤트 설계, 지표 분석까지 라이브 서비스 운영의 전 과정을 경험했으며, SONY 글로벌 팀과의 직접 협업과 매출 구조 개편 등을 주도하며 데이터 기반 의사결정의 기초를 다졌다.',
        team: '사업/기획/운영 협업',
